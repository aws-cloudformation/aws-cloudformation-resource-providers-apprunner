...
// From: https://github.com/aws-cloudformation/cloudformation-cli-java-plugin/blob/master/python/rpdk/java/templates/init/guided_aws/TagHelper.java
public class TagHelper {
     ...
     */
    public static Map<String, String> convertToMap(final Collection<software.amazon.apprunner.observabilityconfiguration.Tag> tags) {
        ...
        return tags.stream()
                ...
                .collect(Collectors.toMap(
                        software.amazon.apprunner.observabilityconfiguration.Tag::getKey,
                        software.amazon.apprunner.observabilityconfiguration.Tag::getValue,
