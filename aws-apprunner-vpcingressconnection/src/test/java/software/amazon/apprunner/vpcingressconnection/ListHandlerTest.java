...
import static software.amazon.apprunner.vpcingressconnection.TestData.RESOURCE_MODEL_SUMMARY;
...
public class ListHandlerTest extends AbstractTestBase{
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().listVpcIngressConnections(any(ListVpcIngressConnectionsRequest.class)))
                .thenReturn(ListVpcIngressConnectionsResponse.builder()
                        .vpcIngressConnectionSummaryList(Arrays.asList(VPC_INGRESS_CONNECTION_SUMMARY))
                        .build());
    ...
    public void handleRequest_EmptyResponse() {
        ...
        when(proxyClient.client().listVpcIngressConnections(any(ListVpcIngressConnectionsRequest.class)))
                .thenReturn(ListVpcIngressConnectionsResponse.builder()
                        .vpcIngressConnectionSummaryList(Collections.emptyList())
                        .build());
