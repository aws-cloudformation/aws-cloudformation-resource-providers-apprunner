...
import static software.amazon.apprunner.vpcconnector.TestData.VPC_CONNECTOR_INACTIVE;
...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void tear_down() {
        verify(apprunnerClient, atLeastOnce()).describeVpcConnector(any(DescribeVpcConnectorRequest.class));
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().describeVpcConnector(any(DescribeVpcConnectorRequest.class)))
                .thenReturn(DescribeVpcConnectorResponse.builder()
    ...
    public void handleRequest_InActive() {
        ...
        when(proxyClient.client().describeVpcConnector(any(DescribeVpcConnectorRequest.class)))
                .thenReturn(DescribeVpcConnectorResponse.builder()
                        .vpcConnector(VPC_CONNECTOR_INACTIVE)
                        .build());
