...
public class TagHelper {
     ...
     */
    public static Map<String, String> convertToMap(final Collection<software.amazon.apprunner.vpcconnector.Tag> tags) {
        ...
        return tags.stream()
                ...
                .collect(Collectors.toMap(
                        software.amazon.apprunner.vpcconnector.Tag::getKey,
                        software.amazon.apprunner.vpcconnector.Tag::getValue,
