...
public class TagHelper {
     ...
     */
    public static Map<String, String> convertToMap(final Collection<software.amazon.apprunner.service.Tag> tags) {
        ...
        return tags.stream()
                ...
                .collect(Collectors.toMap(
                        software.amazon.apprunner.service.Tag::getKey,
                        software.amazon.apprunner.service.Tag::getValue,
